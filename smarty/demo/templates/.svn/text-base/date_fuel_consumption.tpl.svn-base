 ...
 <Worksheet ss:Name="statics">
  <Table x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0" ss:Height="26.25">
    <Cell ss:Index="2" ss:MergeAcross="2" ss:StyleID="s25"><Data ss:Type="String">{$title}</Data></Cell>
   </Row>
   ...
   {section name=num loop=$dateArr}
   <Row ss:AutoFitHeight="0" ss:Height="24.9375">
    <Cell ss:StyleID="s26" ss:Index="2"><Data ss:Type="Number">{$numberArray[num]}</Data></Cell>
    <Cell ss:StyleID="s26"><Data ss:Type="String">{$dateArr[num]}</Data></Cell>
    <Cell ss:StyleID="s26"><Data ss:Type="String">{$consumptionArr[num]}</Data></Cell>
