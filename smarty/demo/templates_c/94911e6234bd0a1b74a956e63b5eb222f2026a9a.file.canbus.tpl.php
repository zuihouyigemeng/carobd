<?php /* Smarty version Smarty-3.1.18, created on 2014-09-10 13:55:09
         compiled from "./templates/canbus.tpl" */ ?>
<?php /*%%SmartyHeaderCode:668644619540fe7bdc3fc60-81867100%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '94911e6234bd0a1b74a956e63b5eb222f2026a9a' => 
    array (
      0 => './templates/canbus.tpl',
      1 => 1410328324,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '668644619540fe7bdc3fc60-81867100',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_540fe7bdced702_48518782',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_540fe7bdced702_48518782')) {function content_540fe7bdced702_48518782($_smarty_tpl) {?><?php echo '<?xml';?> version="1.0"<?php echo '?>';?>
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Styles>
  ...
  <Style ss:ID="s24">
   ...
   </Borders> FontName="宋体" x:CharSet="134" ss:Size="14"/>
  </Style>
  <Style ss:ID="s25">
   <Alignment ss:Horizontal="Center" ss:Vertical="Center"/>
   <Borders/>
 ...
 <Worksheet ss:Name="统计">
  <Table x:FullColumns="1"
   x:FullRows="1" ss:StyleID="s21" ss:DefaultColumnWidth="110"
   ...
   <Row ss:AutoFitHeight="0" ss:Height="26.25">
    <Cell ss:Index="4" ss:MergeAcross="8" ss:StyleID="s25"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="24.9375">
    ...
    <Cell ss:StyleID="s26"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['list']->value[8];?>
</Data></Cell>
    <Cell ss:StyleID="s26"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['list']->value[9];?>
</Data></Cell>
    <Cell ss:StyleID="s26"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['list']->value[10];?>
</Data></Cell>
    <Cell ss:StyleID="s26"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['list']->value[11];?>
</Data></Cell>
    <Cell ss:StyleID="s26"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['list']->value[12];?>
</Data></Cell>
   </Row>
...
?>
   <Row ss:AutoFitHeight="0" ss:Height="24.9375">
    <Cell ss:StyleID="s26" ss:Index="2"><Data ss:Type="String" ><?php echo $_smarty_tpl->tpl_vars['numberArray']->value[$_smarty_tpl->getVariable('smarty')->value['section']['num']['index']];?>
     ...
     <Cell ss:StyleID="s26"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['objArray']->value[$_smarty_tpl->getVariable('smarty')->value['section']['num']['index']][7];?>
</Data></Cell>
     <Cell ss:StyleID="s26"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['objArray']->value[$_smarty_tpl->getVariable('smarty')->value['section']['num']['index']][8];?>
</Data></Cell>
     <Cell ss:StyleID="s26"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['objArray']->value[$_smarty_tpl->getVariable('smarty')->value['section']['num']['index']][9];?>
</Data></Cell>
     <Cell ss:StyleID="s26"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['objArray']->value[$_smarty_tpl->getVariable('smarty')->value['section']['num']['index']][10];?>
</Data></Cell>
     <Cell ss:StyleID="s26"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['objArray']->value[$_smarty_tpl->getVariable('smarty')->value['section']['num']['index']][11];?>
</Data></Cell>
     <Cell ss:StyleID="s26"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['objArray']->value[$_smarty_tpl->getVariable('smarty')->value['section']['num']['index']][12];?>
</Data></Cell>
   </Row>
   <?php endfor; endif; ?>
