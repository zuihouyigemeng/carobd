<?php /* Smarty version Smarty-3.1.18, created on 2015-03-24 14:23:04
         compiled from "./templates/date_fuel_consumption.tpl" */ ?>
<?php /*%%SmartyHeaderCode:115004262853ccd6830a7095-01583235%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f2d6b4798aefbe46b919730e1eb545ac4d3c1ecb' => 
    array (
      0 => './templates/date_fuel_consumption.tpl',
      1 => 1423554685,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '115004262853ccd6830a7095-01583235',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_53ccd68311bc16_18503098',
  'variables' => 
  array (
    'title' => 0,
    'list' => 0,
...
<?php if ($_valid && !is_callable('content_53ccd68311bc16_18503098')) {function content_53ccd68311bc16_18503098($_smarty_tpl) {?><?php echo '<?xml';?> version="1.0"<?php echo '?>';?>
 ...
 <Worksheet ss:Name="statics">
  <Table x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0" ss:Height="26.25">
    <Cell ss:Index="2" ss:MergeAcross="2" ss:StyleID="s25"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</Data></Cell>
   </Row>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['num']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['dateArr']->value) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
   <Row ss:AutoFitHeight="0" ss:Height="24.9375">
    <Cell ss:StyleID="s26" ss:Index="2"><Data ss:Type="Number"><?php echo $_smarty_tpl->tpl_vars['numberArray']->value[$_smarty_tpl->getVariable('smarty')->value['section']['num']['index']];?>
</Data></Cell>
    <Cell ss:StyleID="s26"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['dateArr']->value[$_smarty_tpl->getVariable('smarty')->value['section']['num']['index']];?>
</Data></Cell>
    <Cell ss:StyleID="s26"><Data ss:Type="String"><?php echo $_smarty_tpl->tpl_vars['consumptionArr']->value[$_smarty_tpl->getVariable('smarty')->value['section']['num']['index']];?>
</Data></Cell>
