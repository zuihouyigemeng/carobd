...
<META content="IE=edge" http-equiv="X-UA-Compatible"><TITLE>登录 - 车随行(4S车主版)
...
<TABLE class="classes" border="0" cellSpacing="0" cellPadding="0">
  <TBODY>
  <TR>
    <TD height="91"  style="text-align:left;"><IMG class="logo" align="middle" alt="logo" src="img/logo2.png"></TD>
      ...
      <TABLE border="0" cellSpacing="0" cellPadding="0" width="100%">
        ...
        <TR>
          <TD height="35" align="left">
            ...
            maxLength="20" type="text"  placeholder="用户名"  style="height:30px; value="<?php echo $_COOKIE['name'];?>" >
          <!--   <LABEL id="lblNameTip" 
        ...
        <TR >
          <TD height="35" align="left">
            ...
            maxLength="20" type="text"  value="<?php echo $_COOKIE['password'];?>" >
        ...
        <TR>
          <TD height="20" align="left"><SPAN 
            style="margin-left: 30px;">系统版本：[V1.0.4.02 Build 20141113]<LABEL id="version4s"></LABEL></SPAN></TD></TR></TBODY></TABLE></DIV></TD></TR></TBODY></TABLE></DIV>
...
colSpan="3">&nbsp;</TD></TR></TBODY></TABLE></TD>
    <TD align="right">
      <TABLE class="sidebox" border="0" cellSpacing="0" cellPadding="0">
        <TBODY>
        <TR>
          <TD style="font-weight: bold;" height="32" vAlign="middle" align="center">微信公帐号</TD></TR>
        <TR>
          <TD height="158" align="center"><IMG alt="车随行" src="tmp/getqrcode.bmp" 
            width="138" height="138"></TD></TR>
        <TR>
          <TD style="padding-right: 15px; padding-left: 15px;" 
            vAlign="top">面向4S店及车主OBD应用的车联网云服务解决方案，关注车随行微信服务号就可以体验了。              
...
<P>在安智市场搜索"车随行"下载</P>
<P>车随行安卓版</P><A class="btn-rcx-download" href="http://180.166.124.142:9983/down/obd-163svr.apk"></A></DIV>
<DIV class="p-r"><A class="img-wrap" href="javascript:void(0);"><IMG alt="android" 
src="tmp/android_down.png"></A></DIV></DIV></DIV>
<DIV class="right">
<DIV class="panel ios">
<DIV class="p-l">
<H3 class="title">iPhone版</H3>
<P>iPhone在AppStore搜索"车随行" 下载</P>
<P>车随行iOS版</P><A class="btn-rcx-download" href="https://itunes.apple.com/us/app/che-sui-xing/id789620165?ls=1&mt=8"></A></DIV>
<DIV class="p-r"><A class="img-wrap" href="javascript:void(0);"><IMG alt="ios" 
src="tmp/ios_down.png"></A></DIV></DIV></DIV>
<DIV class="clear"></DIV></DIV>
<DIV id="footer" class="test"><SPAN id="f_copyright">©</SPAN> Copyright 2010-2014 anydata.com 
<A style="padding-right: 3px; padding-left: 3px;" href="http://www.anydata.com/">-关于我们</A>
