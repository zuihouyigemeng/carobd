...
(function($) {
	...
	function _2(_3) {
		...
		function _7(pp) {
			...
			if(pp.panel('panel').css("display") != "none"){
	...
	function _12(_13, _14, el) {
		...
		pp.panel($.extend({}, {
			width : (pp.length
					? parseInt(pp[0].style.width) || pp.outerWidth()
					: "auto"),
			...
			_19.resizable({
						...
						onResize : function(e) {
							if (dir == "north" || dir == "south") {
								...
								_1f.css("top", e.pageY - $(_13).offset().top
												- _1f.height() / 2);
							} else {
								var _1f = $(">div.layout-split-proxy-h", _13);
								_1f.css("left", e.pageX - $(_13).offset().left
												- _1f.width() / 2);
							}
							return false;
						},
						onStopResize : function() {
							$(">div.layout-split-proxy-v", _13).css("display",
									"none");
							$(">div.layout-split-proxy-h", _13).css("display",
									"none");
	...
	function _21(_22, _23) {
		...
		if (_24[_23].length) {
			...
			_24[_23] = $();
			var _25 = "expand" + _23.substring(0, 1).toUpperCase()
					+ _23.substring(1);
			if (_24[_25]) {
	...
	function _26(_27, _28, _29) {
		...
		var _2b = "expand" + _28.substring(0, 1).toUpperCase()
				+ _28.substring(1);
		if (!_2a[_2b]) {
			_2a[_2b] = _2c(_28);
		...
		function _2e() {
			...
			if (_28 == "east") {
				return {
					resizeC : {
						width : _2a.center.panel("options").width
								+ _2a["east"].panel("options").width - 28
					},
					expand : {
				...
				if (_28 == "west") {
					return {
						resizeC : {
							width : _2a.center.panel("options").width
									+ _2a["west"].panel("options").width - 28,
							left : 28
						},
						expand : {
							left : 0
					...
					if (_28 == "north") {
						...
						if (_28 == "south") {
							...
							return {
								...
								expand : {
									top : cc.height()
											- _2a["south"].panel("options").height
								},
								expandP : {
									top : cc.height() - 28,
									left : 0,
	...
	function _31(_32, _33) {
		...
		var _37 = "expand" + _33.substring(0, 1).toUpperCase()
				+ _33.substring(1);
		_34[_37].panel("close");
					...
					if (_33 == "north" && _34.expandNorth) {
						...
						if (_33 == "south" && _34.expandSouth) {
							return {
								...
								expand : {
									top : cc.height()
											- _34["south"].panel("options").height
								}
							};
						}
					}
	...
	$.fn.layout = function(_3f, _40) {
		...
		return this.each(function() {
					...
					if (_41) {
						...
						var _42 = $.extend({}, $.fn.layout.defaults,
								$.fn.layout.parseOptions(this), _3f);
						$.data(this, "layout", {
									options : _42,
									panels : {
										center : $(),
